...
public class DateUtil {
	 ...
	 * @return
	 */
	public static java.util.Date toDate(String str, String pattern, Date defaultDate) {
	 ...
	 * @return
	 */
	public static java.util.Date toDate(int year, int month, int day, int hour, int minute) {
		java.util.Calendar calendar = java.util.Calendar.getInstance();
