...
@Component
public class Menu0101Detail2Impl extends AbstractHpService 
{
	@Override
	public Object serviceCallImpl(Map dataMap)
	{
		...
		// Paging 관련 
		totalCnt = sqlSession.selectOne("ADMIN_MENU01.selEbPassUserListCnt", dataMap);
		...
		// 관리
		List dataList = sqlSession.selectList("ADMIN_MENU01.selEbPassUserList", dataMap);
