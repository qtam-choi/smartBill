...
.mError1 h1{background:url(../images/logo_error.png) 50% 0 no-repeat;font-size:50px;line-height:130%;padding:120px 0 0 0;}
...
<div class="mError1">
	...
	<p class="txt">
		...
		찾으시려는 웹페이지는 이름이 바뀌거나 삭제되어 현재 사용할 수 없습니다.
	</p>
	<div class="mButton1">
		<a href="/main.do" class="mBtn2">홈으로</a>
	</div>
</div>
<!-- //error -->
