...
function goDetail(identify_key){
	var sendObj = document.getElementById("form1");
	
	$('#identify_key').val(identify_key);
                ...
                <div class="ContentWrap">
                    ...
                    <div class="nav">
                        ...
                        <img src="<c:url value='/images/icon_nav.png'/>" alt="step"><span>
                            <strong>전자영수증 사서함관리</strong>
                        </span>
                    </div>
                    <!--title nav end-->
                    <form name="form1" id="form1"  method="POST" >
                    	<INPUT type="hidden" id="curPage" name="curPage" value="${requestScope.paging.curPage}"/>
						<INPUT type="hidden" id="identify_key" name="identify_key" value=""/>
                    ...
                    <table class="BasicTbl2 Tbl_top" style="margin-bottom:10px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>가입채널</th>
                                <td>
                                    <select class="select1" style="width:160px;" name="reg_channel">
                                        <option value="">전 체</option>
                                        <option value="SMARTRO" <c:if test="${param.reg_channel == 'SMARTRO'}"> selected="selected" </c:if>>스마트로</option>
                                        <option value="PASS" <c:if test="${param.reg_channel == 'PASS'}"> selected="selected" </c:if>>패스</option>
                                        <option value="ETC" <c:if test="${param.reg_channel == 'ETC'}"> selected="selected" </c:if>>기타</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="contents">
                        ...
                        <table class="BasicTbl4 Tblink">
                            ...
                            <tr>
		                     ...
		                     <tr onclick="goDetail('${list.identify_key}');" >
